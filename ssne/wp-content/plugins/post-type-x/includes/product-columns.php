...
function add_product_columns( $product_columns ) {
	...
	$new_columns[ 'title' ]						 = __( 'Item Name', 'post-type-x' );
	$new_columns[ 'shortcode' ]					 = __( 'Shortcode', 'post-type-x' );
	//unset($new_columns['taxonomy-al_product-cat']);
	$new_columns[ 'taxonomy-al_product-cat' ]	 = __( 'Item Categories', 'post-type-x' );
	$new_columns[ 'date' ]						 = __( 'Date', 'post-type-x' );
...
/**
 * Order by item categories when clicking on table header label
 * @global object $wpdb
...
/**
 * Adds quick edit support for item fields
 *
...
/**
 * Handles quick edit save for items
 *
