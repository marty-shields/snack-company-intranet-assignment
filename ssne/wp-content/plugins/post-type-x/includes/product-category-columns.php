...
/**
 * Manages item category columns
 *
 * Here all item category columns defined and managed.
 *
 * @version		1.0.0
...
/**
 * Adds info box on item category page
 *
 */
...
function product_category_edit_form_fields( $field ) {
	...
	implecode_upload_image( __( 'Select Category Image', 'post-type-x' ), 'product_cat_image', $cat_img_src, null, 'id' );
}

add_filter( 'manage_edit-al_product-cat_columns', 'product_cat_columns' );

/**
 * Adds item category specific column names
...
/**
 * Adds item category specific column values
 *
 * @param type $depr
