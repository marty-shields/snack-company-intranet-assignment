 ...
 *
 * @version        1.1.4
 * @package        post-type-x/templates/themes
 * @author        Norbert Dreszer
 */

/**
 * Shows example modern grid in item settings
 *
 */
	...
	<div id="content">
		<a href="#default-theme">
			<div class="al_archive"
				...
				<?php if ( function_exists( 'is_ic_price_enabled' ) && is_ic_price_enabled() ) { ?>
 ...
 *
 * @param object $post Item post object
...
function get_default_archive_theme( $post, $archive_template = null ) {
	...
	if ( $archive_template == 'default' ) {
		...
		$return .= apply_filters( 'modern_grid_element_inside', '', $modern_grid_settings );
...
/**
 * Returns modern grid element for a given item category
 *
 * @param object $product_cat Item category object
 * @param string $archive_template
 * @return string
 */
...
/**
 * Adds per row class to modern grid item listing container
 *
 * @param string $class
 * @return string
 */
...
/**
 * Adds image size for modern grid item listing
 *
 */
