...
/**
 * Shows item category child urls
 *
 * @param type $atts
 * @return type
 */
...
/**
 * Returns current item category name
 */
...
/**
 * Shows items on item listing for custom templates usage
 *
 * @return type
 */
...
/**
 * Shows categories on item listing for custom templates usage
 *
 * @return string
 */
...
/**
 * Shows item listing or item page class for templates usage
 *
 * @param type $atts
 * @return string
 */
