...
function ic_start_compatibility() {
	$first_version = (string) get_option( 'PTX_first_activation_version' );
...
/**
 * Disables jetpack infinite scroll on item pages
 *
...
/**
 * Sets item page image html if was modified by third party
 */
...
/**
 * Replaces the item page image HTML with the default
 *
 * @global type $product_page_image_html
 * @param type $html
 * @return \type
